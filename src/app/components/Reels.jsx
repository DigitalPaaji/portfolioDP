...
<button 
            ...
            <motion.div
              ...
              className={`relative w-full h-full  max-h-screen p-4 md:p-12 flex justify-center items-center ${data.find(item=>item.category==subcat)?.gallery[selectedAsset].landscape ?"w-full" :"max-w-7xl"}`}
