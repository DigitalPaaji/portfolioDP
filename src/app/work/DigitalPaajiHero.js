 ...
 const portfolioImages = [
  ...
  return (
    ...
    <div className="flex w-full bg-[#050505] min-h-screen font-sans relative no-scrollbar overflow-hidden">
     ...
     <div className="absolute  top-1 md:top-4 right-1 md:right-5  z-99">
          ...
          >
            {services.map((service, index) => (
              <motion.div
                ...
                onClick={() =>{ select === service ? router.push(`/work`):router.push(`/work?search=${service.split(" ").join("-")}`) } }
              >
             {/* {   setSelect(select === service ? "" : service)} */}
          ...
          >
            {services.map((service, index) => (
              <motion.div
                ...
                onClick={() => {router.push(`/work?search=${service.split(" ").join("-")}`),setToggleCate(false) }}
              >
                {/* setSelect(service),setToggleCate(false) */}
                <span className="text-sm md:text-md font-medium uppercase tracking-[0.2em] text-gray-200 group-hover:text-white transition-colors">
                  {service}
                </span>
              </motion.div>
          ...
          {select && (
            ...
            >
              ...
              <div className="w-full ">
                ...
                <p className=" text-xl text-white cursor-pointer md:hidden  " onClick={()=>router.push("/work")}><ChevronsDown className="rotate-90" /></p>
              ...
              {select === "Video Presentations" && <Presentations />}
